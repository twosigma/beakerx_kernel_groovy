...
import com.twosigma.beakerx.groovy.evaluator.MagicCommandConfigurationMock;
...
public class InteractiveTest {
  ...
  public void setUp() throws Exception {
    ...
    groovyKernel = new KernelTest("1", groovyEvaluator, MessageCreator.get(), new MagicCommandConfigurationMock());
  ...
  private Message initSyncDataMessage(String id, String value) {
    ...
    return MessageFactoryTestMock.initCommMessage(content);
  }
