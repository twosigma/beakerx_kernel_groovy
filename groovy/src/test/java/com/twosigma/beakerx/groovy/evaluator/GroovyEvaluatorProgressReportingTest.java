...
public class GroovyEvaluatorProgressReportingTest {
  ...
  public void setUp() throws Exception {
    ...
    groovyKernel = new KernelTest(GROOVY_EVALUATOR_PROGRESS_REPORTING_TEST, groovyEvaluator, MessageCreator.get(), new MagicCommandConfigurationMock());
  ...
  public void progressReporting() throws Exception {
    ...
    String code =
            "for ( int i = 0 ; i<5; i++) {\n" +
                    ...
                    "}\n" +
                    "\"finished\"";
    SimpleEvaluationObject seo = new SimpleEvaluationObject(code, new KernelTest.SeoConfigurationFactoryMock(groovyKernel, MessageCreator.get(), new MagicCommandConfigurationMock()));
    //when
