...
public class GroovyOutputContainerTest {
  ...
  public void setUp() throws Exception {
    ...
    groovyKernel = new KernelTest("GroovyOutputContainerTest", evaluator, MessageCreator.get(), new MagicCommandConfigurationMock());
    this.evaluator = evaluator;
    evaluator.updateEvaluatorParameters(new EvaluatorParameters(new HashMap()));
    KernelManager.register(groovyKernel);
    evaluationObjectFactory = SimpleEvaluationObjectFactory.get();
  }
  ...
  public void shouldAddPlotToOutputContainerTest() throws Exception {
    ...
    //when
    EvaluationObject evaluationObject = evaluationObjectFactory.createSeo(code, groovyKernel, HEADER_MESSAGE, 1);
